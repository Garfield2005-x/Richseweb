...
export default function BiorichsePage() {
    return (
        <div className="bg-[#010000] text-[#F8E1EB] font-sans selection:bg-[#F07098] selection:text-white min-h-screen flex flex-col overflow-x-hidden">
            {/* Custom Styles */}
            <style jsx global>{`
        .glass-tile {
          ...
          border: 1px solid rgba(248, 225, 235, 0.05);
        }
        .signature-gradient {
          background: linear-gradient(135deg, #F07098 0%, #F394B8 100%);
        }
      ...
      `}</style>
            ...
            <main className="flex-grow pt-4 pb-8 px-6 max-w-7xl mx-auto w-full">
                ...
                <div className="flex flex-col gap-4 items-center lg:items-start">
                    ...
                    <div className="w-full flex flex-col gap-2 items-center lg:items-start">
                        <div className="relative group">
                            <div className="absolute -inset-2 bg-[#F07098]/10 rounded-2xl blur-xl group-hover:bg-[#F07098]/20 transition-all duration-700"></div>
                            <Image
                                className="relative w-32 h-32 lg:w-40 lg:h-40 object-contain rounded-2xl shadow-xl bg-white/5 backdrop-blur-md p-4"
                        ...
                        <div className="space-y-1 text-center lg:text-left">
                            <h1 className="text-3xl lg:text-5xl font-bold tracking-tighter text-[#F8E1EB]">
                                RICH&apos;SE <span className="text-[#F07098]">BRAND</span> ★
                            </h1>
                            <p className="text-base lg:text-lg text-[#F8E1EB]/60 font-light leading-relaxed max-w-md">
                        ...
                        <div className="flex gap-2">
                            <div className="glass-tile px-4 py-2 rounded-lg flex flex-col items-center">
                                <span className="text-xl font-bold text-[#F07098]">188.4K</span>
                                <span className="text-[0.5rem] uppercase tracking-widest text-[#F8E1EB]/40">Followers</span>
                            </div>
                            <div className="glass-tile px-4 py-2 rounded-lg flex flex-col items-center">
                                <span className="text-xl font-bold text-[#F394B8]">Active</span>
                                <span className="text-[0.5rem] uppercase tracking-widest text-[#F8E1EB]/40">Community</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex-grow">
                                <h2 className="text-lg md:text-3xl font-bold text-[#010000] leading-tight">
                                    Group Affiliate Community
                                </h2>
                                <p className="text-[0.7rem] md:text-sm text-[#010000]/60">ค่าคอม12-20%</p>
                            </div>
                            <div className="relative z-10 flex items-center justify-between md:w-full">
                                <span className="hidden md:inline-block text-xl font-bold text-[#010000]">Com 10-15%</span>
                                <div className="bg-[#010000] text-white p-2 md:px-6 md:py-2 rounded-full text-xs md:text-sm flex items-center gap-2 transition-all uppercase font-bold tracking-widest shadow-lg">
                        ...
                        >
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-[0.7rem] md:text-sm text-[#F8E1EB]/40">Exclusive discounts & deals.</p>
                            </div>
                            <div className="shrink-0 text-[#F07098]">
                        ...
                        >
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-[0.7rem] md:text-sm text-[#F8E1EB]/40">Official Line Support</p>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-[0.7rem] md:text-sm text-[#F8E1EB]/40">Updates & Lifestyle</p>
                            </div>
                            <div className="shrink-0 text-[#F07098]">
                        ...
                        >
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-[0.7rem] md:text-sm text-[#F8E1EB]/40">Official Brand Page</p>
                            </div>
                            <div className="shrink-0 text-[#F07098]">
                        ...
                        <Link
                            className="md:col-span-2 group relative overflow-hidden bg-[#F8E1EB] text-[#010000] p-4 md:p-5 rounded-[1rem] flex flex-row md:flex-col items-center md:justify-between min-h-[70px] md:min-h-[120px] active:scale-[0.98] transition-transform hover:bg-[#F07098] hover:text-white gap-3 md:gap-0"
                            href="/"
                        >
                            ...
                            <div className="relative z-10 flex items-center justify-between md:mt-2">
                                ...
                                <div className="bg-[#010000] text-white p-2 md:px-6 md:py-2 rounded-full text-xs md:text-sm flex items-center gap-2 transition-all font-bold shadow-lg group-hover:bg-[#F394B8]">
                ...
                <div className="mt-4 glass-tile rounded-[1.5rem] p-4 md:p-6 flex flex-col md:flex-row items-center justify-center text-center overflow-hidden relative border border-white/5">
                    <div className="absolute left-0 top-0 w-1/3 h-full bg-[#F07098]/5 blur-3xl rounded-full"></div>
                    <div className="relative z-10">
                        <h2 className="text-xl lg:text-2xl font-bold mb-1 tracking-tight">
                            สัมผัสประสบการณ์ช้อปปิ้งระดับพรีเมียม
                        </h2>
                        <p className="text-[#F8E1EB]/60 text-sm md:text-base">
            ...
            {/* Footer */}
            <footer className="w-full flex flex-col items-center justify-center gap-2 bg-[#010000] py-8 border-t border-white/5">
                <div className="text-sm font-bold text-[#F8E1EB] uppercase tracking-widest">RICH&apos;SE BRAND ★</div>
                <div className="flex gap-8">
                    <a className="text-[0.75rem] uppercase tracking-widest text-[#F8E1EB]/30 hover:text-[#F07098] transition-all" href="#">
                        Privacy Policy
                    </a>
                    <a className="text-[0.75rem] uppercase tracking-widest text-[#F8E1EB]/30 hover:text-[#F07098] transition-all" href="#">
                        Contact
                ...
                <p className="text-[0.6rem] uppercase tracking-[0.2em] text-[#F8E1EB]/20 mt-4">Powered by Richse</p>
            </footer>
        </div>
    );
}
