  ...
  return (
    <div className="bg-[#161314] text-white py-2.5 px-4 relative z-[60] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-4 text-center">
        ...
        >
          <span className="bg-[#c3a2ab] text-[#161314] text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-tighter">
            PROMO
          </span>
          <p className="text-[11px] md:text-xs font-medium tracking-[0.1em] uppercase">
