      ...
      <footer className="bg-white py-16 border-t border-[#efecec]">
              <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-12">
                  <div className="max-w-sm space-y-6">
                      ...
                      <p className="text-[16px] text-gray-500 leading-relaxed">Science-backed luxury for your most luminous skin. Defining the future of premium beauty rituals.</p>
              ...
              <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                  <p className="text-[12px] text-gray-400 uppercase tracking-widest">© {new Date().getFullYear()} Richse Beauty. All Rights Reserved.</p>
                  <div className="flex gap-6 text-[12px] text-gray-400 uppercase tracking-widest">
