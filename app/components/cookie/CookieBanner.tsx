...
export default function CookieBanner() {
  ...
  }, [consent, isInitialized, shouldShow]);
    ...
    <>
      <AnimatePresence>
        {shouldShow && (
          ...
          >
            <div className="bg-white dark:bg-[#1c191a] text-[#1c191a] dark:text-white w-full max-w-4xl p-6 md:p-8 rounded-2xl shadow-2xl border border-gray-100 dark:border-white/10 pointer-events-auto flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed text-balance">
              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-3 w-full md:w-auto min-w-fit">
                <button
                  ...
                  className="px-6 py-2.5 text-xs font-bold tracking-widest uppercase rounded-full border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 transition-all text-center"
                >
                  ตั้งค่าคุกกี้
                </button>
                <button
                  onClick={rejectAll}
                  className="px-8 py-2.5 text-xs font-bold tracking-widest uppercase rounded-full bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition-all text-center"
                >
                  ปฏิเสธ
                </button>
                <button
