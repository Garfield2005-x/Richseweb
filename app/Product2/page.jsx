...
<h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-medium text-[#161314] dark:text-white leading-tight mb-4">Richse Gold Mask</h2>
...
<span className="text-3xl font-light text-[#161314] dark:text-white">฿279.00</span>
<span className="text-sm text-gray-500 dark:text-gray-400">10ml</span>
</div>
